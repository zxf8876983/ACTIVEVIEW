...
注意：
    采样不考虑人体朝向评分与遮挡（这些在 predictive_evaluator 中计算）。
    v4.0 的 pred_score / true_score 新增遮挡感知字段。
"""
...
class CandidateView:
    ...
    v4.0 的 pred_score / true_score 新增字段：
        - S_action_occ_pred, S_kp_occ_pred, occlusion_rate_pred
        - occluded_keypoints_pred, visible_keypoints_occ_pred
        - S_action_occ_true, S_kp_occ_true, occlusion_rate_true
    """
    candidate_id: int
    position: np.ndarray
    yaw: float
