...
# EXP020 trains one fixed small gate on Train, then evaluates once on Val.
...
EXP019_RESULT="${DATA_ROOT}/experiments/stage_d/EXP019_executed_candidate_gate/result.json"
OUT="${DATA_ROOT}/experiments/stage_d/EXP020_contextual_latent_gate"
...
(cd "${REPO_ROOT}" && python -m activeview.scripts.train_stage_d_contextual_gate \
