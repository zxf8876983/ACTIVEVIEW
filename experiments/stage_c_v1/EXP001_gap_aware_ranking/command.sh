...
python -m activeview.scripts.evaluate_research_experiment \
  --model-type set_ranker \
  --feature-root "${DATA_ROOT}/datasets/policy_v11_5/stage_c" \
  --stage-b-root "${DATA_ROOT}/datasets/policy_v11_5/stage_b" \
  --dataset-root "${DATA_ROOT}/datasets/policy_v11_5" \
  --checkpoint "${DATA_ROOT}/experiments/stage_c_v1/EXP001_gap_aware_ranking/checkpoints/set_ranker_best.pth" \
  --baseline-dir "experiments/stage_c_v1/EXP001_gap_aware_ranking" \
  --output-dir "${DATA_ROOT}/experiments/stage_c_v1/EXP001_gap_aware_ranking/runtime"
