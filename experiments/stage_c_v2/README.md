...
EXP008--EXP010 have completed their authorized Train-to-Val runs; Test remains
locked and no Test evaluation was performed.
...
These are Val-only diagnostics pending human scientific review; no automatic
Stage C-v2 acceptance decision is made here.
