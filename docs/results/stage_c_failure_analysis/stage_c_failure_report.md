...
The dominant failure type is **C2_wrong_high_utility_loss**. High-regret episodes are concentrated in: jump (153), walk (143), stumble (141), stand up (130), jog (99). Region counts among G3 are: living_room (398), dining_area (386), kitchen (365), bedroom (229).
...
- Among misses with Oracle utility >1e-6, selected utility reaches ≥90%/75%/50% of Oracle in 29.45%/36.63%/44.67%.
...
- Geometry analysis includes absolute azimuth bins, geodesic/radius distributions, selected-versus-Oracle geometry and candidate-set utility-gap bins.
...
- Top 10% records account for 40.20% of catastrophic top-5% episodes.
- Worst and best 20 motion records are included in `record_failure_table.csv` and the JSON summary.

## Scientific answers

1. High regret is not strongly concentrated in a small record subset under the top-10% diagnostic.
...
7. Symmetric-geometry ambiguity affects 1053 episodes under the stated tolerance, with 2350 large-difference pairs; enrichment is descriptive.
...
- `summary`: `/home/zxf/WorkSpace/code/data/ActiveView/datasets/policy_v11_5/stage_c/failure_analysis/stage_c_failure_summary.json`
- `episode_table`: `/home/zxf/WorkSpace/code/data/ActiveView/datasets/policy_v11_5/stage_c/failure_analysis/episode_failure_table.csv`
- `record_table`: `/home/zxf/WorkSpace/code/data/ActiveView/datasets/policy_v11_5/stage_c/failure_analysis/record_failure_table.csv`
- `figures`: `/home/zxf/WorkSpace/code/data/ActiveView/datasets/policy_v11_5/stage_c/failure_analysis/figures`

### Per-action detail

| Action | n | NoMove Acc | Set Acc | SafeOracle Acc | Set gain | Mean regret | P90 regret | Headroom |
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| stumble | 639 | 9.08% | 16.90% | 41.63% | +7.82% | 3.330 | 8.549 | 60.49% |
| play instrument | 213 | 15.96% | 21.60% | 62.44% | +5.63% | 4.490 | 12.296 | 50.94% |
| lie | 213 | 40.85% | 26.76% | 82.16% | -14.08% | 5.022 | 11.991 | 31.61% |
| knock | 213 | 14.08% | 36.15% | 55.40% | +22.07% | 3.289 | 9.659 | 71.01% |
| throw | 639 | 24.73% | 48.36% | 76.06% | +23.63% | 2.285 | 7.832 | 72.41% |
| walk | 1420 | 32.61% | 51.97% | 81.83% | +19.37% | 1.863 | 6.155 | 71.14% |
| jump | 1420 | 38.80% | 54.65% | 85.85% | +15.85% | 1.887 | 6.346 | 75.21% |
| kick | 852 | 30.99% | 58.45% | 84.74% | +27.46% | 1.666 | 6.150 | 73.14% |
| stand up | 1420 | 45.07% | 61.83% | 81.13% | +16.76% | 1.453 | 5.779 | 69.65% |
| cartwheel | 142 | 50.70% | 64.08% | 93.66% | +13.38% | 1.583 | 6.174 | 73.09% |
| jog | 1136 | 41.20% | 68.13% | 89.79% | +26.94% | 1.389 | 5.609 | 83.39% |
| move up/down incline | 1349 | 32.10% | 68.42% | 87.03% | +36.32% | 1.091 | 3.845 | 83.79% |
| crawl | 284 | 43.31% | 71.48% | 90.85% | +28.17% | 0.983 | 3.673 | 80.37% |
| sit | 1420 | 58.87% | 80.07% | 90.85% | +21.20% | 1.058 | 3.926 | 67.94% |
| a pose | 994 | 58.75% | 82.49% | 96.48% | +23.74% | 0.928 | 3.471 | 85.29% |
| t pose | 1420 | 62.18% | 83.03% | 96.55% | +20.85% | 0.793 | 3.211 | 83.80% |

### Semantic-region detail

| Region | n | NoMove Acc | Set Acc | SafeOracle Acc | Set gain | Mean regret | P90 regret | Headroom | Set stay | Safe stay |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| bedroom | 2522 | 37.55% | 61.74% | 82.12% | +24.19% | 1.539 | 5.755 | 79.48% | 28.35% | 15.82% |
| dining_area | 3492 | 39.60% | 63.66% | 88.17% | +24.05% | 1.723 | 6.428 | 73.85% | 28.64% | 11.60% |
| kitchen | 3880 | 38.58% | 61.52% | 80.80% | +22.94% | 1.554 | 5.872 | 77.29% | 31.70% | 14.30% |
| living_room | 3880 | 47.86% | 63.07% | 86.42% | +15.21% | 1.623 | 6.222 | 68.46% | 36.60% | 18.51% |
...
- Oracle absolute azimuth mean/median: 68.58° / 45.00°; model-selected move: 81.62° / 90.00°.
- Oracle geodesic mean/median: 2.725 / 2.210 m; model-selected move: 3.130 / 2.879 m.
- Oracle radius direction counts (closer/same/farther): {'closer': 6954, 'same': 2853, 'farther': 3967}; model-selected move: {'closer': 7412, 'same': 1625, 'farther': 372}.

| Oracle geodesic bin | n | Mean regret | Headroom capture |
|---|---:|---:|---:|
| q0_q25 | 3439 | 1.467 | 50.97% |
| q25_q50 | 3401 | 1.638 | 70.00% |
| q50_q75 | 3488 | 1.414 | 79.96% |
| q75_q100 | 3446 | 1.939 | 79.33% |
...
| small | 6887 | 22.88% | 0.826 | 3.055 | 85.05% |
| medium | 10330 | 26.19% | 1.281 | 5.025 | 79.42% |
