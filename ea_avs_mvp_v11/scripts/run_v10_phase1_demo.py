...
from ea_avs_mvp_v11.core.config import load_v10_config
...
from ea_avs_mvp_v11.dataset.v10_dataset_generator import V10DatasetGenerator
...
def run_phase1_demo():
    ...
    demo_dir = repo_root / "ea_avs_mvp_v11" / "examples" / "v10_phase1_demo"
...
```bash
conda run -n habitat python -m ea_avs_mvp_v11.scripts.run_v10_phase1_demo
```
"""
