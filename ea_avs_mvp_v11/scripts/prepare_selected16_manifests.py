#!/usr/bin/env python3
"""Prepare the selected 16-class pure-color Habitat Train/Val manifests."""
...
from ea_avs_mvp_v11.dataset.babel_selected16_manifest import (
...
def main() -> None:
    runtime_root = __import__("ea_avs_mvp_v11.core.paths", fromlist=["get_data_root"]).get_data_root()
