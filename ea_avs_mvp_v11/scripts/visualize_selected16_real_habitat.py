#!/usr/bin/env python3
"""Render one validation motion per selected16 label in a real HM3D scene.

The output is a side-by-side RGB/YOLO26n-Pose and VideoPose3D visualization.
Only RGB observations are fed to the perception chain; AMASS joints are used
solely to drive the Habitat humanoid.
"""
...
from ea_avs_mvp_v11.core.paths import (
    get_data_root,
...
from ea_avs_mvp_v11.scripts.visualize_household_rgb_to_3d_pipeline import (
