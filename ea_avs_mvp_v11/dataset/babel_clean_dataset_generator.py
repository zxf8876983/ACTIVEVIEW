"""Generate selected16 estimated skeletons with the canonical YOLO26n flow.

Only RGB observations leave Habitat. AMASS/SMPL poses drive the articulated
object, while RGB is processed by YOLO26n-Pose, VideoPose3D and the shared
gravity/root/scale/yaw-only normalizer. Ground-truth joints never enter ST-GCN.
"""
...
from ea_avs_mvp_v11.core.paths import get_data_root, get_humanoid_urdf_path
from ea_avs_mvp_v11.dataset.babel_selected16_manifest import SELECTED_LABELS
from ea_avs_mvp_v11.dataset.humanoid_grounding import (
    ground_humanoid_to_floor,
    humanoid_geometry_y_bounds,
)
from ea_avs_mvp_v11.perception.ultralytics_pose3d_estimator import UltralyticsPose3DEstimator
...
from ea_avs_mvp_v7.motion.amass_loader import NormalizedMotion
