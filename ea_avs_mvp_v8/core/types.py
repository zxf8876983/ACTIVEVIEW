...
包含：
    1. CandidateViewpoint: 机器人候选观察视点数据结构；
...
class CandidateViewpoint:
    """机器人候选观察视点数据结构。"""
    viewpoint_id: str              # 视点标识符 (如 view_001)
    position: List[float]          # 机器人底盘三维坐标 [x, y, z]
    ...
    reason: str = "valid"          # 状态说明 (valid, out_of_bounds, collision, unreachable)
    metadata: Dict[str, Any] = field(default_factory=dict)
