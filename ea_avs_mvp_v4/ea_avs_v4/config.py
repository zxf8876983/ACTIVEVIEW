...
# v4.0 必要字段 —— 相比 v3.0 新增 occlusion 段与遮挡评分权重
REQUIRED_FIELDS = [
    "habitat.scene_path",
    "camera.width",
    "camera.height",
