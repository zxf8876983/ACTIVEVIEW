...
from activeview.perception.pose3d_estimator import BasePose3DEstimator
from activeview.perception.skeleton_definition import (
    SkeletonDefinition,
...
class UltralyticsPose3DEstimator(BasePose3DEstimator):
    ...
    def _frame_result(self, joints: np.ndarray, confidence: np.ndarray):
        from activeview.perception.pose3d_estimator import Pose3DEstimationResult
