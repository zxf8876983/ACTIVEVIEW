...
from activeview.perception.pose.estimator import BasePose3DEstimator
from activeview.perception.skeleton import (
    SkeletonDefinition,
...
class UltralyticsPose3DEstimator(BasePose3DEstimator):
    ...
    def _frame_result(self, joints: np.ndarray, confidence: np.ndarray):
        from activeview.perception.pose.estimator import Pose3DEstimationResult
