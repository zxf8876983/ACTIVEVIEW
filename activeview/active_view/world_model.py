"""Candidate-conditioned future perceived-skeleton world models.

The module intentionally keeps the observation model small and explicit.  It
accepts only already observed skeletons/beliefs/RGB and a candidate descriptor;
future skeletons are returned as targets, never as inputs.
"""
...
from activeview.active_view.geometry import relative_view_descriptor
