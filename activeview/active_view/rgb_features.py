"""DINOv2 RGB cache and the lightweight EXP024 regression head.

Only already visited Stage-D ``s0`` and ``s1`` observations are represented by
the cache.  Future candidate images are intentionally not part of this module's
key builder or embedding inputs.
"""
