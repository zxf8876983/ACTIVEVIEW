...
from activeview.perception.skeleton import SkeletonDefinition, get_skeleton_definition
...
def load_checkpoint(
    ...
    category_count: int,
    device_name: str,
) -> tuple[STGCN, torch.device]:
    """Load a frozen ST-GCN checkpoint for data and evaluation callers."""
    device = torch.device(
