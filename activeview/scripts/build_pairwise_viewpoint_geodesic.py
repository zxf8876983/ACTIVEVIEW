#!/usr/bin/env python3
"""Build a navigation-only 32x32 Habitat shortest-path cache.

This script loads one HM3D navmesh and candidate metadata. It creates no
sensor, RGB/depth frame, humanoid or perception output.
"""
