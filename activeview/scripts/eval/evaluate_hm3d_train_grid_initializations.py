...
from activeview.scripts.eval.evaluate_hm3d_train_dynamic_reachability import (
    COMPLETED_SCENES,
    REGIONS,
    _load_candidates,
    _load_mapping,
...
from activeview.scripts.eval.evaluate_hm3d_train_random_initializations import (
    _aggregate,
