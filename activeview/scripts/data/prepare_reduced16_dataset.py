#!/usr/bin/env python3
"""Prepare the independent 16-class, diversity-aware BABEL protocol."""
...
from activeview.data.motion.reduced12_protocol import build_reduced16_protocol


def main() -> None:
    data_root = get_data_root()
    parser = argparse.ArgumentParser(description=__doc__)
    parser.add_argument("--output-root", type=Path, default=data_root / "datasets" / "reduced16_babel_diversity_v1")
    ...
    summary = build_reduced16_protocol(
