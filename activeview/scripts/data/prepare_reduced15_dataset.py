#!/usr/bin/env python3
"""Prepare the independent 15-class, diversity-aware BABEL protocol."""
...
from activeview.data.motion.reduced12_protocol import build_reduced15_protocol
...
def main() -> None:
    ...
    parser.add_argument(
        "--output-root",
        type=Path,
        default=data_root / "datasets" / "reduced15_babel_diversity_v1",
    )
    ...
    summary = build_reduced15_protocol(
