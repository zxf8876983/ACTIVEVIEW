#!/usr/bin/env python3
"""Prepare diversity-aware reduced-12 BABEL manifests."""
...
from activeview.data.motion.reduced12_protocol import build_reduced12_protocol
...
def main() -> None:
    ...
    parser.add_argument(
        "--output-root",
        type=Path,
        default=data_root / "datasets" / "reduced12_babel_diversity_v1",
    )
    ...
    summary = build_reduced12_protocol(
