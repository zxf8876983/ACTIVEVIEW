#!/usr/bin/env python3
"""Generate reduced16 fixed-30-frame skeleton data with 16 workers."""
...
def main() -> None:
    ...
    parser.add_argument("--data-root", type=Path, default=data_root / "datasets" / "reduced16_babel_diversity_v1" / "stgcn_development")
    ...
    if args.workers != 16:
        raise ValueError("reduced16 protocol requires exactly 16 workers")
    summary = generate(
