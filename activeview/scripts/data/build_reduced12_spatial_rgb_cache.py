#!/usr/bin/env python3
"""Extract the formal 4x4 DINOv2 spatial cache for reduced12 visited RGB."""
...
from activeview.perception.rgb_features import (
    load_dinov2,
...
def build_cache(data_root: Path, device: torch.device, batch_size: int) -> dict[str, object]:
    ...
    rgb_root = data_root / "datasets/rgb_reduced12_eight_placement_v1/visited_s0_s1"
    cache_dir = data_root / (
        "features/dinov2_vitb14_spatial4x4_reduced12_eight_placement/initial_history"
    )
...
def main() -> None:
    ...
    if device.type == "cuda" and not torch.cuda.is_available():
        raise RuntimeError("CUDA unavailable; DINO extraction requires GPU")
