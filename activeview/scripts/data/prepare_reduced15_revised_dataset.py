#!/usr/bin/env python3
"""Prepare the revised 15-class BABEL protocol."""
...
from activeview.data.motion.reduced12_protocol import build_reduced15_revised_protocol


def main() -> None:
    data_root = get_data_root()
    parser = argparse.ArgumentParser(description=__doc__)
    parser.add_argument("--output-root", type=Path, default=data_root / "datasets" / "reduced15_revised_babel_diversity_v1")
    ...
    summary = build_reduced15_revised_protocol(
