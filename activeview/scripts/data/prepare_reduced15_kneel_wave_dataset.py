#!/usr/bin/env python3
"""Prepare the 15-class protocol replacing jump with wave."""
...
from activeview.data.motion.reduced12_protocol import build_reduced15_kneel_wave_protocol
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default=data_root / "datasets" / "reduced15_kneel_wave_babel_diversity_v1",
    )
    ...
    summary = build_reduced15_kneel_wave_protocol(
